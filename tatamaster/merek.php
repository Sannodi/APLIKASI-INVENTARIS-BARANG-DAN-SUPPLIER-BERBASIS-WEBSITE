...
<head>
  ...
  <title>TATA ASTANA Admin - Merek</title>
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Merek Barang</div>
          <div class="card-body">
		  <form method="POST" action="merek.php">
              ...
              <table class="table table-bordered" id="formjenis" width="100%" cellspacing="0">
				...
				<tr>
				  <td colspan="2">
					...
					<button type="submit" class="btn btn-primary btn-lg btn-block" name="mrkbrg">Simpan</button>
				  </td>
				</tr>
                </tbody>
              </table>
