          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered"  width="100%" cellspacing="0">
				...
				<?php
        $nomor=1;
				$rs=mysqli_query($conn,"select * from pembelian p, user u where p.id_pel=u.id_pel AND status_pem = 'Terverifikasi'group by p.id_pem");
                ...
                <!--<tfoot>
                  <tr>
                    <th scope="col" colspan="3">Total </th>
          					<th scope="col" colspan="2">Rp. <?php  ?></th>
                  </tr>
                </tfoot>-->
              </table>
              <table>
                <tr>
                  <td></td>
                  <td></td>
                  <td><a href="#" class="btn btn-success" data-toggle="modal" data-target="#reportModal">
                    <i class="fas fa-fw fa-print"></i> Print Laporan</a></td>
                </tr>
              </table>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="control-group">
           ...
           <div class="col-sm-6">
           <input type="date" name="end" value="<?php echo date('Y-m-d'); ?>" class="form-control">
           </div>
          </div>
        </div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a href="cetak.php"><button type="submit" name="print" class="btn btn-success">Print</button></a>
        </div>
      </div>
    </div>
  </div>
