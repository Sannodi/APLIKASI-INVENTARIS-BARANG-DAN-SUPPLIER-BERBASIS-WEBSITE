<?php 
   ...
   if(isset($_POST['tmbhbrg'])){
		...
		@$gambar=$_POST['image'];
		@$des_brg=$_POST['desk'];
		$sql="INSERT INTO `barang`(`id_jns`, `id_mrk`, `harga_brg`, `stok_brg`, `gambar`, `deskrip`) VALUES ('$jenis_brg', '$merek_brg', '$harga_brg', '$stok_brg', '$gambar', '$des_brg')";
		$rs=mysqli_query($conn,$sql);
			 echo "<script>
					alert('Data Berhasil Disimpan');
					window.location='tmbhbrg.php';
					</script>";
	}
?>
...
<html lang="en">
  ...
  <body>
	...
	<!-- form -->
	<div class="container-fluid">
	<form method="POST" action="tmbhbrg.php">
		<table class="table">
		  <thead>
			<tr>
			  <th colspan="2">
			  <!-- Nav Menu -->
				<div class="container">
					<ul class="nav nav-pills nav-fill">
					  ...
					  <li class="nav-item">
						<a class="nav-link active" href="tmbhbrg.php">Tambah Barang</a>
					  </li>
					  <li class="nav-item">
			...
			<tr>
			  <th scope="col" colspan="2"><h3><p class="text-center">Form Tambah Barang</p></h3></th>
			</tr>
		  </thead>
		  <tbody>
			<tr>
			...
			<tr>
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="stkbrg" name="stkbrg" placeholder="Stok">
				</div>
			  </td>
			  <td>
				</br>
