              ...
              <table class="table table-bordered" id="formjenis" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th scope="col" width="9.1%">Ukuran </th>
                    <th scope="col" width="9.1%">Panjang</th>
                    <th scope="col" width="9.1%">Tebal</th>
                    <th scope="col">Deskripsi Barang</th>
          					<th scope="col" width="25.5%">Opsi</th>
                  </tr>
                </thead>
                <tbody>
        				<?php
                $nomor = 1;
        				$rs=mysqli_query($conn,"select * from barang b, merek m, jenis j where m.id_mrk=b.id_mrk AND j.id_jns=b.id_jns AND b.id_brg=$id_brg");
        				while($row=mysqli_fetch_array($rs)){
        					echo "<tr>";
        						echo "<td>".$nomor."</td>";
        						echo "<td>".$row['nama_mrk']." ".$row['nama_jns']."</td>";
                    echo "<td>".$row['ukuran_brg']." M</td>";
                    echo "<td>".$row['panjang_brg']." M</td>";
                    echo "<td>".$row['tebal_brg']." mm</td>";
                    echo "<td>".$row['deskrip']."</td>";
        						echo "<td><a class='btn btn-primary' href='dashboard.php'>List Barang</a> <a class='btn btn-success' href='ubhbrg.php?id=".$row['id_brg']."'>ubah</a>
                              <a class='btn btn-danger' href='hapus.php?id=".$row['id_brg']."'>hapus</a>
        							  </td>";
        					echo "</tr>";
                $nomor++;
        				}?>
