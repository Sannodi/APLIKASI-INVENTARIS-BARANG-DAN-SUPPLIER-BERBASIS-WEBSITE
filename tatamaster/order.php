          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered"  width="100%" cellspacing="0">
				...
				<?php
        $nomor=1;
				$rs=mysqli_query($conn,"select * from pembelian p, user u where p.id_pel=u.id_pel AND (p.status_pem='Pending' OR p.status_pem='Sudah Dibayar' OR p.status_pem='Pembayaran Tidak Sah') GROUP BY p.id_pem");
            ...
            echo "<td><a href='detlap.php?id=".$row['id_pem']."' class='btn btn-primary'>detail</a>
							  </td>";
					echo "</tr>";
          $nomor++;
				}?>
